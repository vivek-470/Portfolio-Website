    ...
    <section  id='portfolio' >
      ...
      <div className=' mt-[-100px] md:mt-7 h-[300px] flex justify-center  flex-col gap-7 px-2'>
       ...
       <div className='flex gap-5 '>
        <a href='https://spotify-clone-vivek.vercel.app/'><button className='h-[50px] w-[120px] bg-purple-500 rounded-2xl text-white font-semibold cursor-pointer hover:bg-purple-600'>View Site</button></a>
